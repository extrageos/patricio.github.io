export const siteConfig = {
  ...
  skills: [
    ...
    },
    {
      ...
      description:
        "Knowledge of logic gates, combinational/sequential circuits, and FPGA development using Verilog/VHDL for implementing hardware-level designs and system simulations.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Skilled in bridging hardware components with software through driver development, serial communication, and system-level optimization for efficient performance.",
    },
    {
      name: "Computer Architecture & Hardware Fundamentals",
      description:
        "Understanding of CPU design, memory organization, and I/O systems, with the ability to apply concepts in real-world hardware projects and performance analysis.",
    },
  ],
  projects: [
    {
